{{-- Markdown styling for docs rendered inside the panel. Plain CSS rather than utilities because CommonMark's output carries no classes. Include once per page. --}}
<style>
    .pa-guide { max-width: 62rem; line-height: 1.7; }
    .pa-guide > :first-child { margin-top: 0; }
